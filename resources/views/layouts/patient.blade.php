...
<head>
    ...
    <meta name="description" content="Booking jadwal dokter online — cepat, mudah, langsung terhubung ke WhatsApp Anda.">
    ...
    <style>
        ...
        .gradient-hero { background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 40%, #075985 100%); }
        .card-glass { backdrop-filter: blur(10px); background: rgba(255,255,255,0.95); }
    </style>
    @stack('styles')
</head>
<body class="bg-slate-50 min-h-screen">
    ...
    <footer class="text-center py-6 text-slate-400 text-xs">
        ...
        <p class="mt-1">Powered by sistem antrian digital</p>
    </footer>
